...
_DTYPE_TO_FIELD_MAP = {
    ...
    "COMPLEX64": "float_contents",
    "STRING": "string_contents",
    "DOUBLE": "double_contents",
    "COMPLEX128": "double_contents",
    "INT32": "int_contents",
    "IN16": "int_contents",
    "UINT16": "int_contents",
    "INT8": "int_contents",
    ...
    "HALF": "int_contents",
    "INT64": "long_contents",
    "OBJECT": "struct_contents",
    "STRUCT": "struct_contents",
    "UINT32": "uint32_contents",
    "UINT64": "uint64_contents",
    # "QINT32": "bytes_contents",
    # "QINT16": "bytes_contents",
    # "QUINT16": "bytes_contents",
    # "QINT8": "bytes_contents",
    # "QUINT8": "bytes_contents",
    # "BFLOAT16": "int_contents",
}
...
_DTYPE_TO_STRING_MAP = {
    ...
    "FLOAT": "float32",
    "COMPLEX64": "complex64",
    "STRING": "<U",  # <U is little-edian unicode, S: zero-terminated bytes (not recommended)
    "DOUBLE": "float64",
